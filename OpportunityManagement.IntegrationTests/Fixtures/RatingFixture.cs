...
namespace OpportunityManagement.IntegrationTests.Fixtures
{
    public class RatingFixture
    {
        public RatingFixture()
        {
            ...
            systemUserConfigurator.ConfigureUser(testingUser.Id, SecurityRoleNames.Salesperson); // out-of-the-box security role
